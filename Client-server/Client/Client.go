...
func main() {
	...
	for scanner.Scan() {
		go method(ctx, c, scanner.Text())
	}
}

//Private method that calls the SendMessage method defined in the proto file
func method(ctx context.Context, client pb.ServiceClient, message string) {
...
func join(ctx context.Context, client pb.ServiceClient) {
